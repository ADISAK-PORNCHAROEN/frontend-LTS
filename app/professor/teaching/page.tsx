...
export default function Page() {
    ...
    const handleNavigationCreate = () => {
        router.push(`/professor/teaching/createTeaching?sub=${subId}&cur=${curId}`);
    };

    const handleNavigationEditPush = () => {
        const semesterEncode = encode(semesterValue)
        const yearEncode = encode(yearValue)
        router.push(`/professor/teaching/editTeaching?sub=${subId}&cur=${curId}&sem=${semesterEncode}&year=${yearEncode}`);
    }
